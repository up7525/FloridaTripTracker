...
public class DbAdapter {
    ...
    public static final String K_TRIP_EVERYSTOP_TRAVELED = "travelBy";
    public static final String K_TRIP_EVERYSTOP_MEMBERS = "members";
    public static final String K_TRIP_EVERYSTOP_NONMEMBERS = "nonmembers";
    public static final String K_TRIP_EVERYSTOP_DELAYS = "delays";
    public static final String K_TRIP_EVERYSTOP_PAYTOLL = "toll";
    public static final String K_TRIP_EVERYSTOP_PAYTOLLAMT = "tollAmt";
    public static final String K_TRIP_EVERYSTOP_PAYPARKING = "payForParking";
    public static final String K_TRIP_EVERYSTOP_PAYPARKINGAMT = "payForParkingAmt";
    public static final String K_TRIP_EVERYSTOP_FARE = "fare";
    ...
    private static final String TABLE_CREATE_TRIPS = "create table trips "
    	+ "(_id integer primary key autoincrement, purp text, travelBy text, members integer, nonmembers integer, delays integer, toll integer, tollAmt double, payForParking integer, payForParkingAmt double, fare double, start double, endtime double, "
    	+ "fancystart text, fancyinfo text, distance float,"
    ...
    public boolean addCoordToTrip(long tripid, TripPoint pt) {
     ...
     * indicate failure.
     */
    public long createTrip(String purp, String travelBy, int members, int nonmembers, String delays, String toll, double tollAmt, String payForParking, double payForParkingAmt, double fare,
    		double starttime, String fancystart) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(K_TRIP_PURP, purp);
        initialValues.put(K_TRIP_EVERYSTOP_TRAVELED, travelBy);
        initialValues.put(K_TRIP_EVERYSTOP_MEMBERS, members);
        initialValues.put(K_TRIP_EVERYSTOP_NONMEMBERS, nonmembers);
        initialValues.put(K_TRIP_EVERYSTOP_DELAYS, delays);
        initialValues.put(K_TRIP_EVERYSTOP_PAYTOLL, toll);
        initialValues.put(K_TRIP_EVERYSTOP_PAYTOLLAMT, tollAmt);
        initialValues.put(K_TRIP_EVERYSTOP_PAYPARKING, payForParking);
        initialValues.put(K_TRIP_EVERYSTOP_PAYPARKINGAMT, payForParkingAmt);
        initialValues.put(K_TRIP_EVERYSTOP_FARE, fare);
    ...
    public long createTrip() {
        return createTrip("", "", 0, 0, "", "", 0, "", 0, 0, System.currentTimeMillis(), "");
    }
    ...
    public Cursor fetchAllTrips() {
        Cursor c = mDb.query(DATA_TABLE_TRIPS, new String[] { K_TRIP_ROWID,
                K_TRIP_PURP, K_TRIP_EVERYSTOP_TRAVELED, K_TRIP_EVERYSTOP_MEMBERS, K_TRIP_EVERYSTOP_NONMEMBERS, K_TRIP_EVERYSTOP_DELAYS, K_TRIP_EVERYSTOP_PAYTOLL,
                K_TRIP_EVERYSTOP_PAYTOLLAMT, K_TRIP_EVERYSTOP_PAYPARKING, K_TRIP_EVERYSTOP_PAYPARKINGAMT, K_TRIP_EVERYSTOP_FARE, K_TRIP_START, K_TRIP_FANCYSTART, K_TRIP_FANCYINFO },
    ...
    public Cursor fetchTrip(long rowId) throws SQLException {
        Cursor mCursor = mDb.query(true, DATA_TABLE_TRIPS, new String[] {
                K_TRIP_ROWID, K_TRIP_PURP, K_TRIP_EVERYSTOP_TRAVELED, K_TRIP_EVERYSTOP_MEMBERS, K_TRIP_EVERYSTOP_NONMEMBERS, K_TRIP_EVERYSTOP_DELAYS, K_TRIP_EVERYSTOP_PAYTOLL,
                K_TRIP_EVERYSTOP_PAYTOLLAMT, K_TRIP_EVERYSTOP_PAYPARKING, K_TRIP_EVERYSTOP_PAYPARKINGAMT, K_TRIP_EVERYSTOP_FARE,
                K_TRIP_START, K_TRIP_FANCYSTART,
    ...
    public boolean updateTrip(long tripid, String purp, String travelBy, int members, int nonmembers, int delays, int toll, double tollAmt, int payForParking, double payForParkingAmt, double fare,
    	double starttime, String fancystart, String fancyinfo, int lathigh, int latlow, int lgthigh, int lgtlow, float distance) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(K_TRIP_PURP, purp);
        initialValues.put(K_TRIP_EVERYSTOP_TRAVELED, travelBy);
        initialValues.put(K_TRIP_EVERYSTOP_MEMBERS, members);
